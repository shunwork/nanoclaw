...
**Skills over features.** Contributors shouldn't add features to the codebase directly. Instead, they contribute [claude code skills](https://code.claude.com/docs/en/skills) that transform your fork. You end up with clean code that does exactly what you need.

**Best harness, best model.** This runs on Claude Agent SDK, which means you're running Claude Code directly. The harness matters. A bad harness makes even smart models seem dumb, a good harness gives them superpowers. Claude Code is (IMO) the best harness available.

## What It Supports

- **Telegram Bot I/O** - Message Claude from your phone via Telegram
...
From the main channel (your private chat with the bot), you can manage groups and tasks:
```
...
- `/add-whatsapp` - Add WhatsApp as channel (replace Telegram or add as additional channel)
- `/add-slack` - Add Slack
...
```
Telegram Bot (grammy) --> SQLite --> Event-driven queue --> Container (Claude Agent SDK) --> Response
```
...
Because Telegram's Bot API is clean, well-documented, and doesn't require phone-based authentication. Fork it and run a skill to change it. That's the whole point.
